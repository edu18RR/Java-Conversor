...
public class ConversorGui {
    ...
    // Componentes
    public JFrame frame = new JFrame("Conversor de divisas/ Eduardo Rosas");
    ...
    // Define colores
    private final Color GUI_PURPLE = new Color(0x526ED);
    ...
    public ConversorGui(String[] divisas) {
        ...
        // Titulo
        this.tittle.setBounds(30, 15, 392, 79);
        this.tittle.setFont(this.tittle.getFont().deriveFont(40f));

        // Selectores de divisas
        this.selectorDivisas1.setBounds(24, 119, 150, 50);
        this.selectorDivisas2.setBounds(255, 119, 150, 50);
        this.selectorDivisas1.setFocusable(true);
        this.selectorDivisas2.setFocusable(true);

        // Campos de texto
        this.campoTexto1.setBounds(24, 193, 150, 50);
        this.campoTexto2.setBounds(255, 193, 150, 50);
        this.campoTexto1.setFocusable(true);

        // Botones
        this.botonConvertir.setBounds(24, 264, 385, 50);
        ...
        this.botonIntercambiar.setText("a");
